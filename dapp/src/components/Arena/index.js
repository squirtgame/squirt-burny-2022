...
//       const result = await axios.get(`https://api.bscscan.com/api?module=transaction&action=gettxreceiptstatus&txhash=${response}&apikey=EPYXA7UCN2F1FY95YAKU56VVV3IEMP8V8S`)

       const result = await axios.get(`https://api-testnet.bscscan.com/api?module=transaction&action=gettxreceiptstatus&txhash=${response}`)
